...
{
    NSDictionary *carolinabeach = @{@"image":[UIImage imageWithContentsOfFile:[[NSBundle mainBundle] pathForResource:@"images/carolinabeach" ofType:@"JPG"]],
                                    @"url":@"http://static1.squarespace.com/static/5456ac3de4b0b9880b553803/5456d597e4b00956b2012395/55d7394ee4b0ea12462ad78f/1440168277311/2014-11-27+07.17.46.jpg?format=2500w"};
    
    NSDictionary *cherrystone = @{@"image":[UIImage imageWithContentsOfFile:[[NSBundle mainBundle] pathForResource:@"images/cherrystone"ofType:@"JPG"]],
                                  @"url":@"http://static1.squarespace.com/static/5456ac3de4b0b9880b553803/5456d597e4b00956b2012395/5456f9c0e4b007efb21083d3/1414986197789/IMG_5124.JPG?format=2500w"};
    
    NSDictionary *empire = @{@"image":[UIImage imageWithContentsOfFile:[[NSBundle mainBundle] pathForResource:@"images/empire" ofType:@"JPG"]],
                             @"url": @"http://static1.squarespace.com/static/5456ac3de4b0b9880b553803/5456d597e4b00956b2012395/5456f9c7e4b007efb21083f7/1414986187057/15366423698_ca0cf84e77_o.jpg?format=1500w"};
    
    NSDictionary *lauden = @{@"image":[UIImage imageWithContentsOfFile:[[NSBundle mainBundle] pathForResource:@"images/lauden" ofType:@"JPG"]],
                             @"url":@"http://static1.squarespace.com/static/5456ac3de4b0b9880b553803/5456d597e4b00956b2012395/55d7322ae4b06459b2408af5/1440166444239/2014-10-17+17.17.45-3.jpg?format=1500w"};
    
    NSDictionary *moon = @{@"image":[UIImage imageWithContentsOfFile:[[NSBundle mainBundle] pathForResource:@"images/moon" ofType:@"JPG"]],
                           @"url":@"http://static1.squarespace.com/static/5456ac3de4b0b9880b553803/5456d597e4b00956b2012395/55d73229e4b07fe20b7bed1e/1440166449887/2014-11-05+18.30.19-3.jpg?format=2500w"};
    
    NSDictionary *purpletree = @{@"image":[UIImage imageWithContentsOfFile:[[NSBundle mainBundle] pathForResource:@"images/purpletree" ofType:@"JPG"]],
                                 @"url":@"http://static1.squarespace.com/static/5456ac3de4b0b9880b553803/5456d597e4b00956b2012395/55d73228e4b06459b2408add/1440166444782/2014-11-24+18.36.43.jpg?format=2500w"};
            ...
            if (response) {
                ...
                for (NSURL *url in photoURLs) {
                    ...
                    [[session dataTaskWithRequest:request completionHandler:^(NSData *data,
                        ...
                        [self.store addObject:@{@"image":image,@"url":[url absoluteString]}];
                    }] resume];
                }
...
- (UIImage *) getRandomImage
{
    ...
    {
        [Flurry logEvent:@"getRandomImage"
          withParameters:@{@"store_size":[NSString stringWithFormat:@"%lu", (unsigned long)storeCount],
                           @"image_selected_index":[NSString stringWithFormat:@"%d", imageIndex],
                           @"image_last_selected_index":[NSString stringWithFormat:@"%d", self.lastPicIndex]}];
...
- (NSDictionary *) loadImage:(NSURL *)url
{
    ...
    [[session dataTaskWithURL:url completionHandler:^(NSData *data,
                                                      ...
                                                      NSError *error){
        UIImage *image = [[UIImage alloc] initWithData:data];
        [self.store addObject:@{@"image":image, @"url":url}];
    }] resume];
